...
export const mockTrainerData = {
  ...
  upcomingSessions: [
    ...
    },
    {
      ...
      session_type: "personal",
      session_category: "Personal Training",
      date: "2025-10-21", // Tuesday - to demonstrate splitting
      start_time: "16:30",
      end_time: "17:30",
      status: "confirmed",
      location: "Gym Floor A",
      notes: "Will split the 15:00-19:00 availability block",
      program_id: "prog2",
      program_name: "Cardio & Core",
    },
  ],
  ...
  pastSessions: [
    ...
    },
    {
      ...
      status: "completed",
      location: "Studio B",
      notes: "High energy session, great participation",
      program_id: "prog2",
      program_name: "Cardio & Core",
    },
    {
  ...
  canceledSessions: [
    ...
    },
    {
      ...
      status: "cancelled",
      location: "Studio B",
      notes: "Trainer unavailable - emergency",
      program_id: "prog2",
      program_name: "Cardio & Core",
    },
  ],
